...
/*   Updated: 2019/04/10 18:01:27 by ejommy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "SCAV::FR4G-TP " + this->_name + "take " << amount
		<< " points of damage !" << std::endl;
	...
	{
		this->_hitPoints = 0;
		std::cout << "SCAV::FR4G-TP " + this->_name + " died..." << std::endl;
	}
	else
	{
		this->_hitPoints -= amount;
		std::cout << "SCAV::FR4G-TP " + this->_name + "'s health is " <<
...
{
	std::cout << "SCAV::FR4G-TP " + this->_name + "be repaired " << amount
		<< " points!" << std::endl;
	if (this->_hitPoints + amount > this->_maxHitValue)
	{
		this->_hitPoints = 100;
		std::cout << "SCAV::FR4G-TP " + this->_name + "'s HP is " << this->_hitPoints
		<< " points!" << std::endl;
	}
	else
	{
